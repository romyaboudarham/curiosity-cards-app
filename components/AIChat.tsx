  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-12 h-12 rounded-full bg-surface-button-primary hover:bg-surface-button-primary-hover border border-border text-text-button-primary flex items-center justify-center shadow-lg transition-colors cursor-pointer z-50"
      >
      ...
      {open && (
        <div className="fixed bottom-22 right-6 w-80 rounded-xl border border-border bg-surface-background-50 shadow-xl flex flex-col z-50 overflow-hidden">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-border">
            ...
            <button onClick={() => setOpen(false)} className="text-text-body-200 hover:text-text-body cursor-pointer">
              <X className="w-4 h-4" />
            </button>
          </div>
